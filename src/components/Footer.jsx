  ...
  return (
    ...
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      <div className="flex-1 flex flex-col justify-start mr-10">
        <img src={logo} alt="hooBnak" className="w-[266px] h-[72px]"/>
        <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>A new way to make the payment easy ,secure and reliable</p>
      </div>
      ...
      <div className="flex flex-row md:mt-0 mt-6">
      {
        socialMedia.map((social,index)=>(
          <img 
            ...
            src={social.icon}
            alt='social'
            className={`w-[21px] h-[21px] object-contain cursor-pointer ${index!==socialMedia.length? 'mr-6':'mr-0'}`}
          />
        )
        )
      }
